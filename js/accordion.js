...
let changeColorNavBorder = document.querySelector(".change-color-b");
let changeColorNavLines = document.querySelector(".change-color-l");
let logoWhite = document.querySelector(".logo-white");
let logoTur = document.querySelector(".logo-tur");
...
section1.addEventListener("click", () => {
  ...
  if (val1 == "1") {
    ...
    hideContent(title1);
    changeColorNavBarIconsClose();
    hideContent(logoWhite);
    showContent(logoTur);
